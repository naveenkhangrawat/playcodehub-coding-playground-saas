            ...
            <div className='flex items-center lg:justify-between justify-center bg-[#0a0a0f]/80 backdrop-blur-xl p-6 mb-4 rounded-lg'>
                <div className='hidden lg:flex items-center gap-8'>
                    ...
                    <nav className="flex items-center space-x-2">
                        ...
                        <Link href={"/dashboard"} className="flex items-center gap-2 px-4 py-1.5 rounded-lg border border-amber-500/20 hover:border-amber-500/40 bg-gradient-to-r from-amber-500/10 to-orange-500/10 hover:from-amber-500/20 hover:to-orange-500/20 
                        transition-all duration-300">
                            <IconLayoutDashboard className="w-4 h-4 text-amber-400 hover:text-amber-300"/>
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        <ThemeSelector />
                        <LanguageSelector isProMember={Boolean(convexUser?.isProMember)} />
                    </div>

                    {!convexUser?.isProMember && (
                        <Link href={"/pricing"} className="flex items-center gap-2 px-4 py-1.5 rounded-lg border border-amber-500/20 hover:border-amber-500/40 bg-gradient-to-r from-amber-500/10 to-orange-500/10 hover:from-amber-500/20 hover:to-orange-500/20 
                        transition-all duration-300">
