...
import StatsSectionLoadingSkeleton from './StatsSectionLoadingSkeleton';
...
function StatsSection() {
    ...
    const STATS = [
        ...
        },
        {
            ...
            value: userStats?.totalStarredSnippets || 0,
            icon: Star,
            ...
            metric: {
                label: "Most starred",
                value: userStats?.languagesStarredStats?.mostStarredLanguage || "N/A",
                icon: Trophy,
            },
        },
        {
            label: "Languages Used",
            value: userStats?.totalLanguages || 0,
            icon: Code2,
            ...
            metric: {
                label: "Most used",
                value: userStats?.languagesExecutedStats?.favouriteLanguage || "N/A",
                icon: TrendingUp,
            },
        },
      ];
    ...
    return (
        ...
        {(!userData || !userStats || !isLoaded) && (
            <StatsSectionLoadingSkeleton />
        )}
        </>
    )
}
